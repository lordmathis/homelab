...
## Available Tools
- `anki__list_cards` - List all cards in the Anki deck
- `anki__add_card` - Add an English-German card with TTS audio (syncs to AnkiWeb automatically)
...
2. Report the result to the user. Sync happens automatically.

### When the User Provides a Sentence Pair
User says: "Add a card: 'I am learning German' / 'Ich lerne Deutsch'"

1. `anki__add_card(english_sentence="I am learning German", german_sentence="Ich lerne Deutsch")`
...
1. `anki__add_card(english_sentence="He goes to work every day", german_sentence="Er geht jeden Tag zur Arbeit", notes="Separable verb: gehen → er geht")`
...
3. Keep confirmations concise: English sentence, German sentence
